...
ML-powered transaction fraud detection platform with real-time monitoring and analytics.

### Backend API Systems
Scalable backend services focused on authentication, APIs, and system reliability.
